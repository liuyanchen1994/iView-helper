...
export function activate(context: vscode.ExtensionContext) {
	...
	let registration = vscode.workspace.registerTextDocumentContentProvider('iview-helper', docs);
	...
	let disposable = vscode.commands.registerCommand('iview-helper.search', () => {
        // if (context.workspaceState.get('iview-helper.loading', false)) {
